...
1. Check the [Wiki - I need to enter a password every time I switch](https://github.com/KeinNameVorhanden/AccountSwitcherGO/wiki/FAQ---More-Info#i-need-to-enter-a-password-every-time-i-switch) for solutions on what could be going wrong.
2. If the above article was no use to you, and you're still experiencing an issue, you can open an issue. However, if this issue is not widespread, and caused by an update: It is more than likely A. Your computer, software running on it or its configuration. B. A configuration error or unique issue that affects the Account Switcher. Or C. User-error.
