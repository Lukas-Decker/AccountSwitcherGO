...
Thank you for contributing to the Account Switcher! If you have any questions or doubts, don't be afraid to send them my way. I appreciate all contributions, and I am looking forward to fostering an open, transparent, and collaborative environment.

Before contributing, I encourage you to also read or [LICENSE](https://github.com/KeinNameVorhanden/AccountSwitcherGO/blob/main/LICENSE), also found in this repository. If you have any inquiries or questions not answered by the content of this repository, feel free to open an issue.
...
See: [Building from source code](https://github.com/KeinNameVorhanden/AccountSwitcherGO/wiki/Building-from-source-code) in the project's Wiki.
