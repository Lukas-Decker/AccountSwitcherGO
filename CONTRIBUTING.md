...
Before contributing, I encourage you to also read or [LICENSE](https://github.com/TCNOCo/Account-Switcher/blob/master/LICENSE), also found in this repository. If you have any inquiries or questions not answered by the content of this repository, feel free to [join the Discord](https://s.tcno.co/AccSwitcherDiscord) and ask in `#general-acc-switcher` under `TCNO ACCOUNT SWITCHER`.
...
See: [Building from source code](https://github.com/TCNOCo/Account-Switcher/wiki/Building-from-source-code) in the project's Wiki.
